...
namespace Crack_Tomb{
    ...
    public class Boden{
        ...
        public Boden(float PosX, float PosY, float PosZ) {
            ...
            verIntern[1] = new VertexPositionColor(new Vector3(PosX + 0.2f, PosY, PosZ), Color.White);
            verIntern[2] = new VertexPositionColor(new Vector3(PosX, PosY, PosZ + 0.2f), Color.White);
            verIntern[3] = new VertexPositionColor(new Vector3(PosX + 0.2f, PosY, PosZ + 0.2f), Color.White);
