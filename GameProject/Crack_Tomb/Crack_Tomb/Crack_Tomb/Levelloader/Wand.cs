...
namespace Crack_Tomb{
   ...
   public class Wand : Level_Objekt{
        ...
        public Wand(float hPosX, float hPosY, float hPosZ){
            ...
            PosY = hPosY;
            PosZ = hPosZ;
            verIntern[0] = new VertexPositionColor(new Vector3(PosX, PosY, PosZ), Color.Red);
            verIntern[1] = new VertexPositionColor(new Vector3(PosX + SizeX, PosY, PosZ), Color.Red);
            verIntern[2] = new VertexPositionColor(new Vector3(PosX, PosY, PosZ + SizeZ), Color.Red);
            verIntern[3] = new VertexPositionColor(new Vector3(PosX + SizeX, PosY, PosZ + SizeZ), Color.Red);
            verIntern[4] = new VertexPositionColor(new Vector3(PosX, PosY + SizeY, PosZ), Color.Red);
            verIntern[5] = new VertexPositionColor(new Vector3(PosX + SizeX, PosY + SizeY, PosZ), Color.Red);
            verIntern[6] = new VertexPositionColor(new Vector3(PosX, PosY + SizeY, PosZ + SizeZ), Color.Red);
            verIntern[7] = new VertexPositionColor(new Vector3(PosX + SizeX, PosY + SizeY, PosZ + SizeZ), Color.Red);
   ...
   public class Wand_Loch : Level_Objekt {                                    //identische Mechanik wie normale Wand, nur mit andererer Textur und Kollisionserkennung für den Strahl
